...
CREATE TABLE student_course_grades (
    ...
    FOREIGN KEY (student_id) REFERENCES students (student_id) -- Assuming students table exists and has student_id
);

        
INSERT INTO universities (university_id, university_name, address, phone, email)
